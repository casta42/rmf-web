...
/**
 * Info: info<br/>Warning: warning<br/>Critical: critical
 * @export
 * @interface Severity1
 */
...
/**
 * \'open\' (unresolved), \'resolved\' (archive), or omit for all
 * @export
 * @interface Status
 */
...
export interface TortoiseContribPydanticCreatorApiServerModelsTortoiseModelsAlertsAlertLeaf {
  ...
  /**
   *
   * @type {UnixMillisResolvedTime}
   * @memberof TortoiseContribPydanticCreatorApiServerModelsTortoiseModelsAlertsAlertLeaf
   */
  unix_millis_resolved_time?: UnixMillisResolvedTime;
}
/**
 *
 * @export
 ...
 *
 * @export
 * @interface UnixMillisResolvedTime
 */
export interface UnixMillisResolvedTime {}
/**
 *
 * @export
...
export const AlertsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @summary Get Alerts
     * @param {Status} [status] \&#39;open\&#39; (unresolved), \&#39;resolved\&#39; (archive), or omit for all
     ...
     * @throws {RequiredError}
     */
    resolveAlertAlertsAlertIdResolvePost: async (
      alertId: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'alertId' is not null or undefined
      assertParamExists('resolveAlertAlertsAlertIdResolvePost', 'alertId', alertId);
      const localVarPath = `/alerts/{alert_id}/resolve`.replace(
        `{${'alert_id'}}`,
        encodeURIComponent(String(alertId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AlertsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async resolveAlertAlertsAlertIdResolvePost(
      alertId: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.resolveAlertAlertsAlertIdResolvePost(alertId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AlertsApi.resolveAlertAlertsAlertIdResolvePost']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const AlertsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    resolveAlertAlertsAlertIdResolvePost(
      alertId: string,
      options?: any,
    ): AxiosPromise<TortoiseContribPydanticCreatorApiServerModelsTortoiseModelsAlertsAlertLeaf> {
      return localVarFp
        .resolveAlertAlertsAlertIdResolvePost(alertId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class AlertsApi extends BaseAPI {
  ...
  public getAlertsAlertsGet(
    ...
    return AlertsApiFp(this.configuration)
      .getAlertsAlertsGet(status, category, severity, fleet, robot, limit, offset, orderBy, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof AlertsApi
   */
  public resolveAlertAlertsAlertIdResolvePost(alertId: string, options?: RawAxiosRequestConfig) {
    return AlertsApiFp(this.configuration)
      .resolveAlertAlertsAlertIdResolvePost(alertId, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const TasksApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {Category2} [category] comma separated list of task categories
     * @param {AssignedTo} [assignedTo] comma separated list of assigned robot names
     * @param {Status1} [status] comma separated list of statuses
...
export const ZonesApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    /**
     * The site\'s zone data: no_go_zones, speed_zones, mutex_zones (coordinates in RMF building-map meters).
     * @summary Get Zones
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getZonesZonesGet: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ZonesApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getZonesZonesGet(
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getZonesZonesGet(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['ZonesApi.getZonesZonesGet']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
 ...
 * @export
 */
export const ZonesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getZonesZonesGet(options?: any): AxiosPromise<object> {
      return localVarFp.getZonesZonesGet(options).then((request) => request(axios, basePath));
    },
  };
};
...
export class ZonesApi extends BaseAPI {
   ...
   * @memberof ZonesApi
   */
  public getZonesZonesGet(options?: RawAxiosRequestConfig) {
    return ZonesApiFp(this.configuration)
      .getZonesZonesGet(options)
      .then((request) => request(this.axios, this.basePath));
  }
}
